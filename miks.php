...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/byket.php" style="color:rgb(126, 126, 126)" > Букеты</a> · Нежный микс</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="../лаб78/flower5.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Нежный микс</p><br><span class="zagl3">150 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="9">
        <input type="hidden" name="name" value="Нежный микс">
        <input type="hidden" name="price" value="150">
        <input type="hidden" name="image" value="../лаб78/flower5.jpg">
        ...
        <hr>
        <p style="font-size:20px; margin-top:15px; text-align:justify">Представляем «Нежный микс» — воплощение нежности и вневременной красоты. Этот изысканный букет сочетает в себе нежное очарование белых роз и гвоздик с освежающим очарованием зеленых наполнителей. </div>
</div>
<br><br><hr>
<footer>
    <div class="footer">
