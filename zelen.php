...
<head>
    ...
    <title>Великолепная зелень</title>
</head>
<body>
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/byket.php" style="color:rgb(126, 126, 126)" > Букеты</a> · Великолепная зелень</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="https://flowersandpowers.nl/wp-content/uploads/2023/10/The-Gorgeous-Greens-L.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Великолепная зелень</p><br><span class="zagl3">110 BYN.</span><br><br>
        <br>
       <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="8">
        <input type="hidden" name="name" value="Великолепная зелень">
        <input type="hidden" name="price" value="110">
        <input type="hidden" name="image" value="https://flowersandpowers.nl/wp-content/uploads/2023/10/The-Gorgeous-Greens-L.jpg">
        ...
        <hr>
        <p style="font-size:20px; margin-top:15px; text-align:justify">Представляем «Gorgeous Green» — воплощение безмятежной элегантности и вневременной красоты. Этот изысканный букет сочетает в себе нежное очарование нетронутых белых лилий и гвоздик с освежающим очарованием зеленых наполнителей. 
        Каждый стебель и цветок в этой композиции, деликатно переплетающийся с неземным дыханием ребенка, был выбран, чтобы олицетворять спокойную симфонию природы.</div>
</div>
<br><br><hr>
<footer>
    <div class="footer">
