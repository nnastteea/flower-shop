...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br>
           <hr>
          <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"> Каталог</span></p>
          <p style="font-size:32px; font-weight:bold; margin-left:180px; margin-top:20px">Каталог</p>
        ...
        <div class="tabl1"><img src="../лаб78/rose.jpg" width="250" height="auto"><br><br> <a href="../лаб78/cvety.php" class="top-btn">Цветы</a></div>
        <div class="tabl1"><img src="../лаб78/flower6.jpg" width="250" height="auto"><br><br> <a href="../лаб78/byket.php" class="top-btn">Букеты</a></div>
        <div class="tabl1"><img src="../лаб78/flower7.jpg" width="250" height="332px"><br><br> <a href="" class="top-btn">Комбинации</a></div>
        <div class="tabl1"><img src="../лаб78/misha1.jpg" width="250" height="auto"><br> <br> <a href="" class="top-btn">Подарки</a></div>
</div></div>
<br><br><hr>
<footer>
    <div class="footer">
