...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/podarki.php" style="color:rgb(126, 126, 126)" > Композиции</a> · Гелевые шарики (6 штук)</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="../лаб78/shariki.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Гелевые шарики (6 штук)</p><br><span class="zagl3">30 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="17">
        <input type="hidden" name="name" value="Шарики (6 штук)">
        <input type="hidden" name="price" value="30">
        <input type="hidden" name="image" value="../лаб78/shariki.jpg">
