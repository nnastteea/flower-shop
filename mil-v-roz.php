...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/byket.php" style="color:rgb(126, 126, 126)" > Букеты</a> · Милашка в розовом</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="https://flowersandpowers.nl/wp-content/uploads/2023/10/The-Pretty-in-Pink-L.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Милашка в розовом</p><br><span class="zagl3">110 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="6">
        <input type="hidden" name="name" value="Милашка в розовом">
        <input type="hidden" name="price" value="110">
        <input type="hidden" name="image" value="https://flowersandpowers.nl/wp-content/uploads/2023/10/The-Pretty-in-Pink-L.jpg">
        ...
        <hr>
        <p style="font-size:20px; margin-top:15px; text-align:justify">Ощутите сияющее очарование букета «Красотка в розовом». Поэтический танец цветов и форм, эта композиция идеально передает нежное тепло летних объятий. 
        Лилии, пионы и гортензии создают картину изящества, а страстные розы и яркие герберы добавляют нотку энергичного очарования.</div>
</div>
<br><br><hr>
<footer>
    <div class="footer">
