...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"> Цветы</span></p>
           <p style="font-size:32px; font-weight:bold; margin-left:180px; margin-top:20px">Цветы</p>
        ...
        <div class="tabl"><img src="../лаб78/rose.jpg" width="250" height="auto"><br><br>Розы белые (40см)<br>8 BYN.<br><br> <a href="../лаб78/cvety1.php" class="top-btn">Выбрать</a></div>
        <div class="tabl"><img src="../лаб78/flower4.jpg" width="250" height="330"><br><br>Кустовые розы<br>8 BYN.<br><br> <a href="../лаб78/cvety2.php" class="top-btn">Выбрать</a></div>
        <div class="tabl"><img src="../лаб78/flower12.jpg" width="250" height="330"><br><br>Хризантемы<br>7 BYN.<br><br> <a href="../лаб78/cvety3.php" class="top-btn">Выбрать</a></div>
        <div class="tabl"><img src="../лаб78/flower2.jpg" width="250" height="330"><br><br>Тюльпаны<br>5 BYN.<br> <br> <a href="../лаб78/cvety4.php" class="top-btn">Выбрать</a></div>
</div></div>
<br><br><hr>
<footer>
    <div class="footer">
