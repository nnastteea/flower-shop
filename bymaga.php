...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/cvety.php" style="color:rgb(126, 126, 126)" > Цветы</a> · Крафтовая бумага</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="https://static.insales-cdn.com/images/products/1/4698/396702298/large_IMG_4221.PNG" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Крафтовая бумага</p><br><span class="zagl3">2 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="19">
        <input type="hidden" name="name" value="Крафтовая бумага">
        <input type="hidden" name="price" value="2">
        <input type="hidden" name="image" value="https://static.insales-cdn.com/images/products/1/4698/396702298/large_IMG_4221.PNG">
