...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/komposiciya.php" style="color:rgb(126, 126, 126)" > Композиции</a> · Композиция в коробочке 3</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="../лаб78/flower7.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Композиция в коробочке 3</p><br><span class="zagl3">210 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="13">
        <input type="hidden" name="name" value="Композиция в коробочке 3">
        <input type="hidden" name="price" value="210">
        <input type="hidden" name="image" value="../лаб78/flower7.jpg">
