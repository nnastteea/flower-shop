...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/byket.php" style="color:rgb(126, 126, 126)" > Букеты</a> · Идеальный персик</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="https://flowersandpowers.nl/wp-content/uploads/2023/10/The-Peach-Perfect-L.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Идеальный персик</p><br><span class="zagl3">110 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="7">
        <input type="hidden" name="name" value="Идеальный персик">
        <input type="hidden" name="price" value="110">
        <input type="hidden" name="image" value="https://flowersandpowers.nl/wp-content/uploads/2023/10/The-Peach-Perfect-L.jpg">
        ...
        <hr>
        <p style="font-size:20px; margin-top:15px; text-align:justify">Представляем букет «The Peach Perfect», гармоничное сочетание лучших цветов природы. Каждая композиция представляет собой симфонию цвета, текстуры и аромата, переносящую вас в сияющий летний сад на пике его расцвета. 
        От нежных лилий и страстных роз до величия эремурусов и георгин — каждый стебель рассказывает историю красоты и жизненной силы.</div>
</div>
<br><br><hr>
<footer>
    <div class="footer">
