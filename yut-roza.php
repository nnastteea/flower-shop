...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/byket.php" style="color:rgb(126, 126, 126)" > Букеты</a> · Уютная роза</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="../лаб78/flower6.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Уютная роза</p><br><span class="zagl3">140 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="10">
        <input type="hidden" name="name" value="Уютная роза">
        <input type="hidden" name="price" value="140">
        <input type="hidden" name="image" value="../лаб78/flower6.jpg">
        ...
        <hr>
        <p style="font-size:20px; margin-top:15px; text-align:justify">Представляем «Уютная роза» — воплощение тепла и спокойствия. Этот изысканный букет сочетает в себе нежное очарование нежнейших роз с освежающим очарованием зеленых наполнителей. </div>
</div>
<br><br><hr>
<footer>
    <div class="footer">
