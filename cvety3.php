...
<div class="start-container">
        ...
        <div class="dropdown-content">
           ...
           <br><br><hr>
           <p style="margin-top:30px"> <a href="../лаб78/index.php" style="font-size:20px; color:black; font-weight:bold; margin-left:180px">Главная ·</a><span style="color:rgb(126, 126, 126)"><a href="../лаб78/cvety.php" style="color:rgb(126, 126, 126)" > Цветы</a> · Хризантемы</span></p>
           <div class="prosmotr">
        <div class="left-part"><img src="../лаб78/flower12.jpg" width="380" height="auto"></div>
        <div class="right-part">
            <p class="zagl2">Хризантемы</p><br><span class="zagl3">7 BYN.</span><br><br>
        <br>
        <form method="post" action="add-to-cart.php">
        <input type="hidden" name="id" value="3">
        <input type="hidden" name="name" value="Хризантемы">
        <input type="hidden" name="price" value="7">
        <input type="hidden" name="image" value="../лаб78/flower12.jpg">
  ...
  <br>
        ...
        <hr>
        <p style="font-size:20px">Вид хризантем (обычные или ромашковые) уточняйте у флористов по номеру <span style="color:rgb(235, 124, 146)">+375 (хх) хх-хх-ххх</span>. <br>Минимальный заказ от 5 штук.
    <br><br>
